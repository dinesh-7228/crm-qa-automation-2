...
public class AutopayCustomerAnalyticsPage extends BrowserAction {
    SoftAssert Assert = new SoftAssert();
    public AutopayCustomerAnalyticsPage(WebDriver driver) {

        this.driver = driver;
    }

@Step("Analytics validation || Analytics App Customer Track validation")
public boolean AutopayCustomerAnalyticsData(ExtentTest extentTest,AccountData accountData) throws InstantiationException, IllegalAccessException, InterruptedException, IOException {
