...
public class APIData {
    ...
    public String toString() {
        return "APIData [testcaseid=" + testcaseid + ", path="
                ...
                + NeedtoExecute + ", Usethisfield=" + UsethisField + ", SetThisField=" + SetThisField + ", GetThisField=" + getGetThisField() + ", Prerequisite=" + getPrerequisite() + ", PaginationValidation=" + getPaginationValidation() +", Order_creation=" + getOrder_creation() +"]";
    }
